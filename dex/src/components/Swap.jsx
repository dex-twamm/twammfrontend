  ...
  return (
    <Fragment>
        ...
        <button className= "btn currency-select" onClick={handleDisplay}>
          <span className="spn-currency">
            <div className="currency">
               <img className="tokenImage" src={tokenA.image} style={{marginRight: '0.5rem'}} alt="token-image"/>
      ...
      <div className="textOutput">
        ...
        {!selectToken  ? <button className = "btn token-select" onClick={handleDisplay}>
        ...
        <button className= "btn currency-select" onClick={handleDisplay}>
          <span className="spn-currency">
            <div className="currency">
               <img className="tokenImage" src={tokenB.image} style={{marginRight: '0.5rem'}} alt="token-image"/>
