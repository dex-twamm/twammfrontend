...
export const ShortSwapProvider = ({children}) => {
 ...
 return <ShortSwapContext.Provider value={{
  swapAmount, setSwapAmount, equivalentAmount, setEquivalentAmount, srcAddress, setSrcAddress, destAddress, setDestAddress
  }}> 
          {children}
